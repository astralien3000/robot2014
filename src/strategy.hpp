...
static const Vect<2, s32> RED_SECOND_FIRE_POINT(-600, 550);

static const Vect<2, s32> RED_FRONT_FRESQ_POINT(0, 550);
static const Vect<2, s32> RED_FRESQ_POINT(0, 2000);

static const Vect<2, s32> RED_ADV_SECOND_FIRE_POINT(600, 550);
static const Vect<2, s32> RED_ADV_BEFORE_FIRST_POINT(1100, 550);
...
static const Vect<2, s32> YELLOW_SECOND_FIRE_POINT(600, 550);

static const Vect<2, s32> YELLOW_FRONT_FRESQ_POINT(0, 550);
static const Vect<2, s32> YELLOW_FRESQ_POINT(0, 2000);

static const Vect<2, s32> YELLOW_ADV_SECOND_FIRE_POINT(600, 550);
static const Vect<2, s32> YELLOW_ADV_BEFORE_FIRST_POINT(1100, 550);
...
static Vect<2, s32> SECOND_FIRE_POINT(-600, 550);

static Vect<2, s32> FRONT_FRESQ_POINT(0, 550);
static Vect<2, s32> FRESQ_POINT(0, 2000);

static Vect<2, s32> ADV_SECOND_FIRE_POINT(600, 550);
static Vect<2, s32> ADV_BEFORE_FIRST_POINT(1100, 550);
